...
import { ArrowLeft, MapPin, Clock, User, Package } from 'lucide-react';
          ...
          <div className="glass-card p-6">
            ...
            <div className="flex gap-3 pt-4 border-t border-surface-100">
              ...
              {pickup.status === 'completed' && (
                <div className="flex-1 text-center p-3 rounded-xl bg-emerald-50 text-emerald-700 font-semibold">
                  ✅ Job completed!
                </div>
              )}
            </div>
